...
SPARQL をより扱いやすくするシステムとして [_**SPARQList Next**_](https://sparqlist-next.vercel.app) を（暫定的に）つくりました．つくったから終わりということではなく，今後も継続的な改修を続けてより良い感じにしていく予定です（現状だと UI / UX ってやつがあんまりよろしくない……）．
